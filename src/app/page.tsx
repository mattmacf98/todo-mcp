...
const TodoListWebComponent = ({mcpClient, handleTodoClick, handlePromptClick}: {mcpClient: MCPClient, handleTodoClick: (title: string, description: string) => void, handlePromptClick: (promptName: string, args?: Record<string, any>) => void}) => {
